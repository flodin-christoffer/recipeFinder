...
const RecipeCard = () => {
    return (  <div className="flex flex-col rounded-md bg-[#ecf7d4] overflow-hidden p-3 relative" >
        <a href="" className="relative h-32">
            <img src="/1.jpg" alt="recipeimage" className="rounded-md w-full h-full object-cover cursor-pointer" />
